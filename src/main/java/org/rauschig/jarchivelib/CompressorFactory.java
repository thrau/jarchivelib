...
/**
 * Factory for creating {@link Compressor} instances by a given compression algorithm. Use the
 * constants in this class to pass to the factory method.
 */
public final class CompressorFactory {
  ...
  /**
   * Probes the given {@link File} for its file type and creates a {@link Compressor} based on this
   * file type.
   *
   ...
   */
  public static Compressor createCompressor(final File file) throws IllegalArgumentException {
    final FileType fileType = FileType.get(file);
   ...
   */
  public static Compressor createCompressor(final FileType fileType) throws IllegalArgumentException {
    if (fileType == FileType.UNKNOWN) {
   ...
   */
  public static Compressor createCompressor(final String compression) throws IllegalArgumentException {
   ...
   */
  public static Compressor createCompressor(final CompressionType compression) {
