...
public class FactoryTest extends AbstractResourceTest {
  ...
  @Test
  public void createArchiver_fromStringArchiveAndCompressionFormat_returnsCorrectArchiver()
      throws Exception {
  ...
  @Test
  public void createCompressor_fromStringCompressionFormat_returnsCorrectCompressor()
      throws Exception {
  ...
  public void createCompressor_fromFile_returnsCorrectCompressor() throws Exception {
    Compressor compressor =
        CompressorFactory.createCompressor(new File(RESOURCES_DIR, "compress.txt.gz"));
